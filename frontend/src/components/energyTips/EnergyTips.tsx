      ...
      <div className={style.energyTips}>
        ...
        <div className={`container ${style.energyTipContent}`}>
          <div className={style.energyTipText}>
            ...
            <p>{`${data[selectedTopic].title} egner seg for deg som:` }</p>
            <ul>
            ...
            <p>{`Gode grunner til å montere ${data[selectedTopic].title}:` }</p>
            <ul>
        ...
        <div className={`container ${style.twoPercent}`}>
          <div className={style.energyTipText}>
            <h1>2% målet</h1>
            <p>
              2% målet er et mål om at
              alle bygg i kommunen skal bruke 2% mindre energi enn året før. Om vi alle gjør dette kan
              vi spare store mengder energi og dermed skape en mer klimavennlig og bærekraftig by, i
              tillegg til at vi tar et steg i riktig retning for å stoppe klimaendringene og få en
              grønnere og friskere planet.
            </p>
          </div>
        </div>
